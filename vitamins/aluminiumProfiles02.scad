...
//Corner Types
BR_20x20_Corner = [30, 10.5, 2.25, 0.75, 6];

// Side Types  - for closed slots
BR_20x20_Side = [30, 2.25];
...
BR_20x20_TwistLockNut = [8.7,16.95,6,1.2,2.25];


// gussets
// width, wall_thickness, slot width, slot height, slot offset from base, nib depth, nib width, label
BR_20x20_Gusset = [27, 4.5, 6.75, 10.5, 11.55, 1.5, 8.7, "BR20x20Gusset"];
